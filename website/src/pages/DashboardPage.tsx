...
export default function Dashboard() {
    ...
    const [isLoadingClaimBalance, setIsLoadingClaimBalance] = useState(false);
    ...
    async function handleClaimBalance() {
        ...
        if (isLoadingClaimBalance) return;
        setIsLoadingClaimBalance(true);
        ...
        try {
            ...
            setIsLoadingClaimBalance(false);
        }
